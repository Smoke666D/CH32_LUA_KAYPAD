...
INIT_FUNC_LOC void HAL_CANInt(  uint8_t   CANbitRate)
{
     ...
     /* Configure CAN timing */
      switch (CANbitRate)
      {
          case 0: CAN_Prescaler  = 2*2;
                  break;
          case 1:  CAN_Prescaler = 4*2;
                  break;
          case 2:  CAN_Prescaler = 8*2;
                  break;
         default:
         case 3:  CAN_Prescaler = 16*2;
                 break;
         case 4:  CAN_Prescaler = 20*2;
                break;
         case 5:  CAN_Prescaler = 120*2;
                break;
         case 6:  CAN_Prescaler = 300*2;
               break;
         case 7:  CAN_Prescaler = 600*2;
              break;
      }
...
/*
Фцнкция инициализации для CAN CHAKER
*/
